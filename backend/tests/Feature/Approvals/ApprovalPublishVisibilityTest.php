...
class ApprovalPublishVisibilityTest extends TestCase
{
    ...
    public function test_featured_recommendation_prefers_long_term_stable_cluster_when_current_window_is_sparse(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('data.summary.top_route_outcome_status', 'safe')
            ->assertJsonPath('data.summary.top_route_outcome_recommended_action_mode', 'jump_to_item')
            ->assertJsonPath('data.featured_recommendation.route_outcome_spotlight.guidance_status', 'safe')
            ->assertJsonPath('data.featured_recommendation.route_outcome_spotlight.recommended_action_mode', 'jump_to_item')
            ->assertJsonPath('data.summary.top_route_outcome_window_days', 90)
            ->assertJsonPath('data.summary.top_route_outcome_window_status', 'safe')
            ->assertJsonPath('data.summary.top_route_outcome_window_recommended_action_mode', 'jump_to_item')
            ->assertJsonPath('data.route_outcome_window_series.0.window_days', 7)
            ->assertJsonPath('data.route_outcome_window_series.1.window_days', 30)
            ->assertJsonPath('data.route_outcome_window_series.2.window_days', 90)
            ->assertJsonPath('data.route_outcome_window_series.2.guidance_status', 'safe')
            ->assertJsonPath('data.featured_recommendation.action_mode', 'jump_to_item')
    ...
    public function test_featured_recommendation_prefers_draft_detail_outcome_when_it_outperforms_approvals_native_flow(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('data.featured_recommendation.route_outcome_spotlight.guidance_status', 'safe')
            ->assertJsonPath('data.featured_recommendation.route_outcome_spotlight.recommended_action_mode', 'jump_to_item')
            ->assertJsonPath('data.featured_recommendation.route_outcome_window_series.0.window_days', 7)
            ->assertJsonPath('data.featured_recommendation.route_outcome_window_series.1.window_days', 30)
            ->assertJsonPath('data.featured_recommendation.route_outcome_window_series.2.window_days', 90)
            ->assertJsonPath('data.featured_recommendation.route_outcome_window_series.2.guidance_status', 'safe')
            ->assertJsonPath('data.featured_recommendation.action_mode', 'jump_to_item')
            ...
            ->assertJsonPath('data.summary.top_route_series_status', 'stable')
            ->assertJsonPath('data.summary.top_route_outcome_status', 'safe')
            ->assertJsonPath('data.summary.top_route_outcome_recommended_action_mode', 'jump_to_item')
            ->assertJsonPath('data.summary.top_route_series_route_key', 'draft_detail')
            ->assertJsonPath('data.featured_recommendation.route_series_spotlight.status', 'stable')
            ->assertJsonPath('data.featured_recommendation.route_series_spotlight.route_key', 'draft_detail')
            ->assertJsonPath('data.featured_recommendation.route_series_spotlight.window_days', 7)
            ->assertJsonPath('data.featured_recommendation.route_outcome_spotlight.guidance_status', 'safe')
            ->assertJsonPath('data.featured_recommendation.route_outcome_spotlight.recommended_action_mode', 'jump_to_item')
            ->assertJsonPath('data.featured_recommendation.decision_context_route_series_status', 'stable')
            ->assertJsonPath('data.featured_recommendation.decision_context_route_series_window_days', 7)
            ->assertJsonPath('data.featured_recommendation.decision_context_route_outcome_status', 'safe')
            ->assertJsonPath('data.featured_recommendation.decision_context_route_outcome_recommended_action_mode', 'jump_to_item')
    ...
    public function test_featured_primary_action_softens_when_recent_route_signal_weakens(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('data.featured_recommendation.action_mode', 'focus_cluster')
            ->assertJsonPath('data.featured_recommendation.route_series_spotlight.status', 'softening')
            ->assertJsonPath('data.featured_recommendation.route_series_spotlight.route_key', 'draft_detail')
            ->assertJsonPath('data.featured_recommendation.route_outcome_spotlight.guidance_status', 'guarded')
            ->assertJsonPath('data.featured_recommendation.route_outcome_spotlight.recommended_action_mode', 'focus_cluster')
            ->assertJsonPath('data.featured_recommendation.decision_context_route_series_status', 'softening')
            ->assertJsonPath('data.featured_recommendation.decision_context_route_outcome_status', 'guarded')
    ...
    public function test_featured_primary_action_stays_cluster_focused_when_approvals_native_outperforms_draft_detail(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('data.summary.top_route_outcome_status', 'blocked')
            ->assertJsonPath('data.featured_recommendation.cluster_key', 'retry-ready')
