...
class AdAccountReportingTest extends TestCase
{
    ...
    public function test_ad_account_detail_returns_scoped_campaign_alert_and_report_data(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('data.recipient_group_failure_alignment_summary.tracked_failed_runs', 1)
            ->assertJsonPath('data.recipient_group_failure_alignment_summary.overridden_failed_runs', 1)
            ->assertJsonPath('data.recipient_group_failure_alignment_summary.top_override_reason_label', 'SMTP Timeout')
            ->assertJsonPath('data.recipient_group_failure_alignment.0.reason_code', 'smtp_timeout')
            ->assertJsonPath('data.recipient_group_failure_alignment.0.dominant_alignment_status', 'override_driven')
            ->assertJsonPath('data.recipient_group_failure_reason_summary.total_reason_types', 1)
            ->assertJsonPath('data.recipient_group_failure_reason_summary.total_failed_runs', 1)
            ...
            ->assertJsonPath('data.retry_recommendation_summary.top_policy_label', 'Otomatik Retry Uygun')
            ->assertJsonPath('data.retry_recommendations.0.reason_code', 'smtp_timeout')
            ->assertJsonPath('data.retry_recommendations.0.primary_action_code', 'retry_failed_runs')
            ->assertJsonPath('data.retry_recommendations.0.provider_label', 'SMTP')
            ->assertJsonPath('data.retry_recommendations.0.delivery_stage_label', 'Baglanti')
            ->assertJsonPath('data.failure_resolution_summary.total_actions', 1)
            ->assertJsonPath('data.failure_resolution_summary.retryable_runs', 1)
            ->assertJsonPath('data.failure_resolution_summary.top_reason_label', 'SMTP Timeout')
            ->assertJsonPath('data.failure_resolution_actions.0.code', 'retry_failed_runs')
            ->assertJsonPath('data.failure_resolution_actions.0.action_kind', 'api')
            ->assertJsonPath('data.failure_resolution_actions.0.metadata.retryable_runs', 1)
