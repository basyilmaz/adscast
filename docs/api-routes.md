...
- `GET /approvals/remediation-analytics`
  ...
  - `featured_recommendation` altinda sistemin su an one cikardigi remediation cluster'ini, karar nedenini, onerilen aksiyon modunu, effectiveness bilgisini, `source_breakdown[]`, `route_trends[]`, `route_series_spotlight`, `outcome_chain_summary`, `draft_detail_outcome_summary` ve gerekiyorsa `decision_context_*` alanlarini doner
